...
export const starterProjects: Project[] = [
  {
    ...
    priority: "High",
    deadline: "This week",
    nextAction: "Complete the next required milestone",
    weeklyHours: 10,
    completed: false,
  },
  {
    id: 2,
    name: "Client / Product Launch",
    category: "Growth",
    priority: "High",
    deadline: "Long-term",
    nextAction: "Ship one useful improvement or deliverable",
    weeklyHours: 6,
    completed: false,
  },
  {
    ...
    priority: "High",
    deadline: "Weekly",
    nextAction: "Send one application, proposal, or follow-up",
    weeklyHours: 3,
    completed: false,
  },
  {
    id: 4,
    name: "Team / Community Operations",
    category: "Maintenance",
    priority: "Medium",
    deadline: "Saturday",
    nextAction: "Prepare the next meeting, session, or update",
    weeklyHours: 3,
    completed: false,
  },
];
